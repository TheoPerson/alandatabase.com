...
const DSN =
	'https://fcd5c306ca6264af03ec42d4c03ef816@o4511905549254656.ingest.de.sentry.io/4511905561051216';
...
async function main() {
	...
	const eventId = Sentry.captureException(
		new Error('AlanDatabase 2026 Production Verification Exception')
	);
